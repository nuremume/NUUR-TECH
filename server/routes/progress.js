...
router.post('/quiz-result', catchAsync(async (req, res, next) => {
...
router.post('/lesson-complete', catchAsync(async (req, res, next) => {
...
router.get('/all', requireRole(['instructor', 'admin']), catchAsync(async (req, res, next) => {
